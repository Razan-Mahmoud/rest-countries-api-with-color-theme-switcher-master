            ...
            <div className="container-fluid pt-4 mb-2 px-4 lightBg mainSection" >
                <div className="row g-4 ">
                    <div className='d-flex justify-content-between my-4'>
                        <input name='search' onChange={(e) => console.log(e.target.value)} className='form-control w-50 elements lightElementsBg' placeholder='Search for a country' />
                    ...
                    {/* .filter((country) => country.name.common.toLowerCase().includes(searchVal)).filter((country) => country.region.toLowerCase().includes(selectVal)) */}
