                ...
                <div className="row align-items-top my-4 ms-2 g-4">
                    ...
                    <div className="col-md-7 item lightElementsBg">
                        ...
                        <p><span className='fw-bold'>Border Countries: </span> {borderDetail.borders?.map((z, i) => {
                            return <Link to={"/details/" + z} className='elements text-decoration-none'><button key={i} className='btn px-4 me-2 bg-transparent elements lightElementsBg border border-2' >{z}</button></Link>
